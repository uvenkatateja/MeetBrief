    ...
    <section className="px-4 py-16 md:py-32">
      <div className="mx-auto grid max-w-5xl border md:grid-cols-2">
        <div>
          <div className="p-6 sm:p-12">
            <span className="text-muted-foreground flex items-center gap-2">
              ...
              Transcript Upload & Custom Prompts
            </span>
            <p className="mt-8 text-2xl font-semibold">
              Upload your meeting or call transcript and add custom instructions for tailored summaries.
            </p>
          </div>
          <div
            aria-hidden
        ...
        <div className="col-span-full border-y p-12">
          <p className="text-center text-4xl font-semibold lg:text-7xl">Summarize. Edit. Share.</p>
        </div>
