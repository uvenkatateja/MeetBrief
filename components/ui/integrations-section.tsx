          ...
          <div className="grid items-center sm:grid-cols-2">
            ...
            <div className="mx-auto mt-6 max-w-lg space-y-6 text-center sm:mt-0 sm:text-left">
              ...
              <p className="text-muted-foreground">
                Generate intelligent meeting summaries and share them instantly via email with professional formatting.
              </p>
              <Button
                variant="outline"
                size="sm"
                asChild
              >
                <Link href="#">Try Email Summary</Link>
              </Button>
            </div>
          </div>
        </div>
...
const IntegrationCard = ({
  ...
  return (
    <div className={cn('bg-background relative flex size-20 rounded-xl dark:bg-transparent', className)}>
      ...
      />
      <div className="relative z-20 m-auto size-fit *:size-8">
        {children}
      </div>
    </div>
  )
